...
export const SampleAppUtilities = (function () {
  ...
  /* function setSuccesStatus() {
    document.getElementById("procesoCompararExitosoInput").setAttribute("value", true.toString());
  }
 */
  ...
  function handleErrorGettingServerSessionToken() {
    showMainUI();
    console.log("passing by handleErrorGettingServerSessionToken");
